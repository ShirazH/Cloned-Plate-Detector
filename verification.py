                ...
                if str(d[i]['frame_id']) == str(found_plates[j]['frame']):
                    ...
                    for k in range(0,len(d[i]['objects'])):
                        ...
                        if plate_cx > x1 and plate_cx < x2 and plate_cy > y1 and plate_cy < y2:
                            print('Plate lies within car bbox')
                            print('Predicted make and model is: ' + str(d[i]['objects'][k]['name']) + ' Actual make and model from reg is: '+str(found_plates[j]['model']))


# fp = [
#     {'reg': 'ydsd5e213so', 'accuracy': 0.902, 'frame': '7', 'crop': '0', 'coords': {'center_x': 0.685907, 'center_y': 0.739965, 'width': 0.065396, 'height': 0.031526}, 'model': 'Toyota Aygo', 'color': 'Black'},
#     {'reg': 'yk65vso', 'accuracy': 0.902, 'frame': '32', 'crop': '0', 'coords': {'center_x': 0.685907, 'center_y': 0.739965, 'width': 0.065396, 'height': 0.031526}, 'model': 'Toyota Prius', 'color': 'Black'}
# ]
# verification(fp)